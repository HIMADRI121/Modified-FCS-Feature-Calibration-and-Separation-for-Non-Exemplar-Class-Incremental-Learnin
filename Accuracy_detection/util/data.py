...
from util.toolkit import split_images_labels
import os 
import sys
...
class iCIFAR10(iData):
    ...
    def download_data(self):
        train_dataset = datasets.CIFAR10(data = data_root, train=True, download=True)
        test_dataset = datasets.CIFAR10(data = data_root, train=False, download=True)
